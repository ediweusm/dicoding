...
const ProducerService = {
  sendMessage: async (queue, message) => {
    const connection = await amqp.connect(config.RABBITMQ_SERVER); // @TODO-2: buat koneksi ke rabbitmq. Referensi: https://www.dicoding.com/academies/271/tutorials/17629
